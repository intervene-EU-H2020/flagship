...
for(l in 1:length(biobank)){
  ...
  for(j in 1:length(phenocols)){
    for(k in c("female")){
      ...
      write.csv(hazards, paste0("/Users/jermy/Documents/INTERVENE/Results/HazardRatios/",biobank[l],"/AgeandSex/",phenocols[j],"_",k,"_Age_Specific_Hazards.csv"))
...
for(l in 1:length(biobank)){
  ...
  for(j in 1:length(phenocols)){
    for(k in c("female")){
      ...
      write.csv(hazards, paste0("/Users/jermy/Documents/INTERVENE/Results/HazardRatios/",biobank[l],"/AgeandSex/",phenocols[j],"_",k,"_Age_Specific_Hazards_OnePercentTails.csv"))
