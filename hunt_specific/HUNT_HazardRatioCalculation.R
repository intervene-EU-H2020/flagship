...
# Set variables 
phenocols <- c("J10_ASTHMA", "C3_CANCER", "K11_APPENDACUT", "I9_AF", "C3_BREAST", "I9_CHD","C3_COLORECTAL",  "G6_EPLEPSY", "GOUT", "COX_ARTHROSIS", "KNEE_ARTHROSIS", "F5_DEPRESSIO", "C3_MELANOMA_SKIN", "C3_PROSTATE",  "I9_SAH", "T1D", "T2D", "ILD", "C3_BRONCHUS_LUNG")
prscols <- c("Asthma","AllCancers","Appendicitis", "Atrial_Fibrillation", "Breast_Cancer", "CHD","Colorectal_Cancer", "Epilepsy","Gout", "Hip_Osteoarthritis", "Knee_Osteoarthritis","MDD", "Melanoma", "Prostate_Cancer", "Subarachnoid_Haemmorhage", "T1D","T2D", "ILD", "Lung_Cancer")
#,  "Rheumatoid_Arthritis"
#""RHEUMA_SEROPOS_OTHER",
...
write.csv(results, paste0(output_dir,"HUNT_AgeStratifiedResults.csv"))